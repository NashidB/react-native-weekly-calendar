...
| loadEvents | `undefined` | `func` | loadEvents is a function that you pass to tell the calendar to load the weeks events. loadEvents should be constructed as this loadEvents(startDate), The calendar will pass it first day of the week. |
